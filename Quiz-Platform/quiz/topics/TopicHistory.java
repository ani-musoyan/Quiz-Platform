...
/**
 * The TopicHistory class represents the History topic in the quiz platform.
 * It allows adding quizzes, selecting quizzes, and getting the list of quizzes associated with the History topic.
 */
public class TopicHistory implements Topic {

    /** The name of the History topic. */
    public static final String name = "History";

    /** The list of quizzes associated with the History topic. */
    private ArrayList<Quiz> quizList = new ArrayList<>();

    /**
     * Adds a quiz to the History topic.
     *
    ...
    /**
     * Gets the name of the History topic.
     *
     * @return The name of the History topic.
     */
    ...
    /**
     * Selects a quiz from the History topic.
     */
    @Override
    ...
    /**
     * Gets the list of quizzes associated with the History topic.
     *
